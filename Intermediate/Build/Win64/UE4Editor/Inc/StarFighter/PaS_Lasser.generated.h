...
#ifdef STARFIGHTER_PaS_Lasser_generated_h
#error "PaS_Lasser.generated.h already included, missing '#pragma once' in PaS_Lasser.h"
#endif
...
public: \
	DECLARE_CLASS(APaS_Lasser, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/StarFighter"), NO_API) \
	DECLARE_SERIALIZER(APaS_Lasser) \
...
#define StarFighter_Source_StarFighter_PaS_Lasser_h_12_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, APaS_Lasser); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APaS_Lasser); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API APaS_Lasser(APaS_Lasser&&); \
	NO_API APaS_Lasser(const APaS_Lasser&); \
public:
...
template<> STARFIGHTER_API UClass* StaticClass<class APaS_Lasser>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID StarFighter_Source_StarFighter_PaS_Lasser_h
